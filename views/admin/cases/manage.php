...
<!-- Duplicate script block removed - functionality consolidated in main script below -->
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function renderConsultations(data) {
        ...
        let html = '<div class="cases-grid cases-grid-3">';
    ...
    // Handle dynamic button clicks using event delegation
